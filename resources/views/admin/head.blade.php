    ...
    <ul class="navbar-nav flex-row ml-auto d-flex align-items-center list-unstyled topnav-menu mb-0">
        <li class="dropdown user-link">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-lg">
                <a href="{{ url('admin/profile-user',auth()->user()->id) }}" class="dropdown-item"> <i class="fal fa-user"></i> My Profile</a>
                <div class="dropdown-divider"></div>
                <a href="{{ route('admin.logout') }}" class="dropdown-item"><i class="fal fa-sign-out"></i> Logout</a>
            </div>
        </li>
    </ul>
</div>