        ...
        <div class="col-sm-12">
            <div class="row">
                <div class="col-lg-12 col-md-4 mb-4">
                    <form class="box bg-white" method="POST" action="{{ route('admin.update_venue_media') }}" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="venue_id" value="{{ $venue_id }}">
                    <input type="hidden" name="update_id" value="{{ $venue_media_details->id }}">
                            ...
                            <div class="col-sm-6" id="imageDiv" style="display:none;">
                                ...
                                <label class="col-md-3 col-form-label">Image</label>
                                    <div class="upload-btn">
                                        <input id="venue_logo" type="file" name="vide_embed_code">
