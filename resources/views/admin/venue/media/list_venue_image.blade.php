        ...
        <div class="page-title col-sm-12">
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    ...
                    <a href="{{ route('admin.create_venue_image',$venue_id) }}" class="btn btn-primary " style="float:right;">Add Image</a>
                </div>
            </div>
        </div>
        <div class="col-sm-12">
                                        ...
                                        @if(!empty($venue_images))
                                            @foreach($venue_images as $venue_image)
                                                <tr>
                                                    ...
                                                    <td><img src="{{ asset('/public/uploads/'.$venue_image->image_media) }}" class="d-block m-auto img-fluid" hight="100px" width="100px" alt="category image"></td>
                                                    <td class="action">
                                                        <a href="{{ url('admin/edit-venue-image/'.$venue_id.'/'.$venue_image->id) }}">
                                                            <button type="button" class="icon-btn edit">
                                                                <i class="fal fa-edit"></i>
                                                            </button>
                                                        </a>
                                                        <a href="{{ url('admin/delete-venue-image/'.$venue_id.'/'.$venue_image->id) }}">
