        ...
        <div class="page-title col-sm-12">
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    ...
                    <a href="{{ route('admin.create_venue_video',$venue_id) }}" class="btn btn-primary " style="float:right;">Add Video</a>
                </div>
            </div>
        </div>
        <div class="col-sm-12">
                        ...
                        <div class="box-row">
                            <div class="box-content">
                                <table id="dataTable" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        @if(!empty($venue_videos))
                                            @foreach($venue_videos as $venue_video)
                                                <tr>
                                                    <th scope="row">{{ $loop->iteration }}</th>
                                                    <td>{{ $venue_video->video_embed_code }}</td>
                                                    <td class="action">
                                                        <!-- <a href="{{ url('admin/show-venue',$venue_video->id) }}">
                                                            <button type="button" class="icon-btn preview">
                                                                <i class="fal fa-eye"></i>
                                                            </button>
                                                        </a> -->
                                                        <a href="{{ url('admin/edit-venue-video/'.$venue_id.'/'.$venue_video->id) }}">
                                                            <button type="button" class="icon-btn edit">
                                                                <i class="fal fa-edit"></i>
                                                            </button>
                                                        </a>
                                                        <a href="{{ url('admin/delete-venue-video/'.$venue_id.'/'.$venue_video->id) }}">
