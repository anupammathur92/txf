	...
	<tbody>
		<tr>
			...
			<table border="0" cellpadding="0" cellspacing="0" class="templateContainer" style="border-collapse: collapse; max-width: 900px; background: #f9f9f9; border: 0;" width="100%">
				<tbody>
					<tr>
						<td id="templatePreheader" style="background: -webkit-linear-gradient(top, rgba(0, 255, 255, 1) 0%, rgba(4, 155, 155, 1) 100%); border-top: 0; border-bottom: 1; padding: 10px 0;" valign="top">
							...
							<tbody class="mcnTextBlockOuter">
								<tr>
									...
									<table align="left" border="0" cellpadding="0" cellspacing="0" class="mcnTextContentContainer" style="border-collapse: collapse; min-width: 100%;" width="100%">
										<tbody>
											<tr>
												<td class="mcnTextContent" style="word-break: break-word; color: #fff; font-size: 30px; line-height: 150%; text-align: center; padding: 9px 18px;" valign="top">Registration Email Verification</td>
											</tr>
										</tbody>
									</table>
									</td>
					...
					<tr>
						...
						<p>You are receiving this email because you have registered on our website</p>

						<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Click the link to &nbsp;<a href="{{$url}}">Verify Email</a></p>
						<p>OTP: {{$otp}}</p>
					...
					<tr>
						<td id="templateFooter" style="background-color: #282828; padding: 25px 0;" valign="top">
							...
							<tbody class="mcnTextBlockOuter">
								<tr>
									...
									<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
										<tbody>
											<tr>
												<td style="text-align: center; color: #fff; font-size: 12px;" valign="top">TixFair</td>
											</tr>
										</tbody>
									</table>
									</td>
