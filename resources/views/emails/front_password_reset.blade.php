							...
							<tbody class="mcnTextBlockOuter">
								<tr>
									...
									<table align="left" border="0" cellpadding="0" cellspacing="0" class="mcnTextContentContainer" style="border-collapse: collapse; min-width: 100%;" width="100%">
										<tbody>
											<tr>
												<td class="mcnTextContent" style="word-break: break-word; color: #fff; font-size: 30px; line-height: 150%; text-align: center; padding: 9px 18px;" valign="top">Reset Password</td>
											</tr>
										</tbody>
									</table>
									</td>
